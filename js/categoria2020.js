...
matchFinaliA[81] = {"white" : {"username":"88arf", "result":"lost"}, "black" : {"username":"yoggsaron99", "result":""}, "url":""}
matchFinaliA[82] = {"white" : {"username":"frank23259", "result":""}, "black" : {"username":"peloritano", "result":""}, "url":""}
matchFinaliA[83] = {"white" : {"username":"rapace", "result":"win"}, "black" : {"username":"saurosol", "result":"lost"}, "url":""}
matchFinaliA[84] = {"white" : {"username":"pumpf", "result":"win"}, "black" : {"username":"tesctassa", "result":"lost"}, "url":""}
matchFinaliA[85] = {"white" : {"username":"paolobarolo", "result":""}, "black" : {"username":"vitellotonnato", "result":""}, "url":""}
matchFinaliA[86] = {"white" : {"username":"sandokann", "result":"lost"}, "black" : {"username":"lupodellasila", "result":"win"}, "url":""}
...
matchFinaliA[41] = {"white" : {"username":"yoggsaron99", "result":""}, "black" : {"username":"", "result":""}, "url":""}
matchFinaliA[42] = {"white" : {"username":"rapace", "result":""}, "black" : {"username":"pumpf", "result":""}, "url":""}
matchFinaliA[43] = {"white" : {"username":"", "result":""}, "black" : {"username":"lupodellasila", "result":""}, "url":""}
matchFinaliA[44] = {"white" : {"username":"sir-h-hornblower", "result":""}, "black" : {"username":"homunculus1", "result":""}, "url":""}
...
matchFinaliB[83] = {"white" : {"username":"elmarba", "result":"lost"}, "black" : {"username":"dag_stinner", "result":"win"}, "url":""}
matchFinaliB[84] = {"white" : {"username":"valeriobc", "result":"win"}, "black" : {"username":"capfracassa", "result":"lost"}, "url":""}
...
matchFinaliB[86] = {"white" : {"username":"maehard", "result":"win"}, "black" : {"username":"schiappone", "result":"lost"}, "url":""}
matchFinaliB[87] = {"white" : {"username":"gd1966", "result":""}, "black" : {"username":"pieropare", "result":""}, "url":""}
...
matchFinaliB[43] = {"white" : {"username":"golia_il_filisteo", "result":""}, "black" : {"username":"maehard", "result":""}, "url":""}
...
//Serie C
matchFinaliC[81] = {"white" : {"username":"marpur", "result":"win"}, "black" : {"username":"abatichs", "result":"lost"}, "url":""}
matchFinaliC[82] = {"white" : {"username":"ytoong", "result":"win"}, "black" : {"username":"babilonia", "result":"lost"}, "url":""}
matchFinaliC[83] = {"white" : {"username":"tizianoparriani", "result":"win"}, "black" : {"username":"sundancek", "result":"lost"}, "url":""}
matchFinaliC[84] = {"white" : {"username":"linchetto", "result":"win"}, "black" : {"username":"dida70", "result":"lost"}, "url":""}
...
matchFinaliC[87] = {"white" : {"username":"kmoreteam", "result":"win"}, "black" : {"username":"pantheon-67", "result":"lost"}, "url":""}
matchFinaliC[88] = {"white" : {"username":"tempiese75", "result":"win"}, "black" : {"username":"cavaliereyedi", "result":"lost"}, "url":""}
matchFinaliC[41] = {"white" : {"username":"marpur", "result":"lost"}, "black" : {"username":"ytoong", "result":"win"}, "url":""}
matchFinaliC[42] = {"white" : {"username":"tizianoparriani", "result":""}, "black" : {"username":"linchetto", "result":""}, "url":""}
...
matchFinaliC[21] = {"white" : {"username":"ytoong", "result":""}, "black" : {"username":"", "result":""}, "url":""}
...
function stampaFinale(tabella, finali)
{
    ...
    var tabellaFinali = [];
     ...
     tabella.append('<tr class="classifica-giocatori">' +  tabellaFinali[186] + '<td></td><td></td><td></td>' +  tabellaFinali[22] + '  <td></td><td></td><td></td></tr>');
     tabella.append('<tr class="classifica-giocatori">' +  tabellaFinali[87] + '<td></td><td></td><td></td>' +  tabellaFinali[122] + ' <td></td><td></td><td></td> </tr>');
